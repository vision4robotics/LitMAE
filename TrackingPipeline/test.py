...
parser.add_argument('--dataset', default='UAVDark135', type=str,
                    help='datasets')    #UAVDark135  DarkTrack2021
...
parser.add_argument('--trackername', default='LitMAE_SiamAPN++', type=str,
                    help='name of tracker')

parser.add_argument('--e_weights', default='./experiments/LitMAE/model.pth', type=str,
                    help='weights')
parser.add_argument('--enhancername', default='LitMAE', type=str,
...
def main():
    ...
    pipeline = build_pipeline(args, enhancer=enhancer)
